...
import { Activity, Lock, Mail, Loader2, UserPlus, LogIn } from 'lucide-react'
      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-xl">
          ...
          <button
            ...
            className="w-full bg-white hover:bg-slate-100 text-slate-900 font-semibold py-2.5 rounded-xl transition-all mb-6 flex items-center justify-center gap-3 shadow-sm border border-slate-200"
          >
